...
def main():
    ...
    result33 = binary_search([1, 2, 3, 4, 5], 3)
    result34 = bubble_sort([3, 1, 4, 2, 5])
    result35 = selection_sort([3, 1, 4, 2, 5])
    result36 = merge_sort([3, 1, 4, 2, 5])
    ...
    print(f"Binary search for 3 in [1, 2, 3, 4, 5] = {result33}")
    print(f"Bubble sort [3, 1, 4, 2, 5] = {result34}")
    print(f"Selection sort [3, 1, 4, 2, 5] = {result35}")
    print(f"Merge sort [3, 1, 4, 2, 5] = {result36}")
